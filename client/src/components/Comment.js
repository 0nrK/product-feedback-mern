                ...
                <div className="flex flex-row justify-between items-center px-5 space-x-12">
                    <div className="flex flex-row space-x-5 ">
                        ...
                        <div className="flex flex-col">
                            <h4 className="font-bold text-xl">{props.user}</h4>
                        </div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" onClick={handleDeleteComment} className="cursor-pointer text-red-500 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
