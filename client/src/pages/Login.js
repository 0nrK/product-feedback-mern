            ...
            <form onChange={handleChange} onSubmit={handleSubmit} className="rounded-lg mx-auto mt-48  bg-red-200 flex flex-col  justify-center w-1/4 h-5/6 p-12 " >
                ...
                <div className="flex flex-row justify-between items-center">
                    ...
                    <button className="flex justify-center items-center p-3 text-white bg-blue-500 w-24 rounded-sm mt-5 ml-auto" type="submit">
                        {isDisabled ? <svg role="status" className="mr-2 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
